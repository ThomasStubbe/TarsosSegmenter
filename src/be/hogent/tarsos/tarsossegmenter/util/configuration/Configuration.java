...
*
 */
package be.hogent.tarsos.tarsossegmenter.util.configuration;

import be.hogent.tarsos.tarsossegmenter.util.StringUtils;
...
//	private static final Logger LOG = Logger.getLogger(Configuration.class.getName());
    ...
    /**
     * The suffix used for a description of a configuration setting.
     */
     ...
     * @return if the key is configured, the configured value. Otherwise the
     * default value is returned.
     * @exception NumberFormatException If the configured value can not be
     * parsed to an integer a is thrown.
     */
     ...
     * case, to the string "true". <p> Example:
     * <code>Boolean.parseBoolean("True")</code> returns
     * <code>true</code>.<br> Example:
     * <code>Boolean.parseBoolean("yes")</code> returns
     * <code>false</code>. </p>
     *
...
//	}
        ...
        if (userPreferences == null || defaultConfProps == null) {
            synchronized (Configuration.class) {
                if (defaultConfProps == null) {
                    ...
                    final InputStream propertiesStream = Configuration.class.getResourceAsStream("configuration.properties");
                    try {
    ...
    public static interface ConfigChangeListener {
         ...
         * method.
         *
         * @param key The changed configuration setting.
         */
